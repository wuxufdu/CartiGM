...
writes:
  ...
  reports/P17_FUSION_ABLATION.md
"""
...
OUTDIR = Path("outputs/fusion_P17")
REPORT = Path("reports/P17_FUSION_ABLATION.md")
ACC_H5AD = "acc.h5ad"
EBR_H5AD = "outputs/EBR/EBR.h5ad"
