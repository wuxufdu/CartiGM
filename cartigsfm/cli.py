...
def main():
    ...
    sgp.add_argument("--h5ad", default="acc.h5ad")
    sgp.add_argument("--outdir", default="outputs/scgpt_pretrain")
    ...
    tf.add_argument("--outdir", default="outputs/fusion_P17")
    tf.add_argument("--report", default="reports/P17_FUSION_ABLATION.md")
