"""Remote DE on EBR.h5ad celltype (7 in-EBR chondrocyte states).

Used to refit the panels on the actual target domain. Saves JSON shaped like
all_celltype_panels_acc.json (`by_group`).
"""
...
OUT = os.environ.get("PANEL_OUT", "/tmp/ebr_celltype_panels.json")
LABEL_COL = os.environ.get("LABEL_COL", "celltype")
